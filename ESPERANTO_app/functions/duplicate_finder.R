...
#' The cross comparison also deals with a typical situation present in the phenodata, such as when the cell contents of a certain column appears as i.e. "age: 22".   
